...
public class Demo {
    ...
    public static void main(String[] args) {
        System.out.println("Please specify social network"
        		+ " to target spam tool (default:Facebook):");
        ...
        spammer.sendSpamToFriends("anna.smith@bing.com",
                ...
                + "Can you do me a favor and like this post [link]?");
        spammer.sendSpamToCoworkers("anna.smith@bing.com",
                "Hey! This is Anna's boss Jason. "
                + "Anna told me you would be interested in [link].");
    }

    public static List<Profile> createTestProfiles() {
        List<Profile> data = new ArrayList<Profile>();
        data.add(new Profile("anna.smith@bing.com", 
        		"Anna Smith", "friends:mad_max@ya.com", "friends:catwoman@yahoo.com",
